...
README.md was inspected for project context (observed blob `9cfe45bd4e9b4ef761bf7b3294812e42628fa630`). Its existing statements are not new runtime verification.
Existing CLAUDE.md contains project-specific rules and must be read before application work.
